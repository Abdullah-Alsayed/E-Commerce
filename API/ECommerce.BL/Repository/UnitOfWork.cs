...
namespace ECommerce.BL.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(Applicationdbcontext context, SignInManager<User> signInManager, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IMailServices mailServices, IHostingEnvironment hosting)
        {
            _context = context;
            ...
            Error  = new BaseRepository<Errors>(_context, _hosting);
            Setting = new BaseRepository<Setting>(_context, _hosting);
            Slider = new BaseRepository<Slider>(_context, _hosting);
        ...
        public IProdactImgRepository ProdactImg { get; private set; }
        ...
        public IBaseRepository<Errors> Error { get; private set; }
