...
using AutoMapper;
using ECommerce.BLL.Features.Governorate.Dtos;
...
public class GovernorateServices : IGovernorateServices
{
    ...
    private readonly IStringLocalizer<GovernorateServices> _localizer;
    ...
    public GovernorateServices(
        ...
        IStringLocalizer<GovernorateServices> localizer,
